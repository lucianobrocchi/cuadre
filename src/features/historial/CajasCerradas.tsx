...
import { estadoCierreEstilo, estadoCierreLabel, historialCopy as t } from './historial.copy';
  ...
  if (cerradas.length === 0) {
    return (
      <div className="mt-16 flex flex-col items-center text-center">
        ...
        <h2 className="mt-4 text-xl font-bold text-cuadre-900">{t.cajasVacioTitulo}</h2>
        <p className="mt-1 text-cuadre-900/60">{t.cajasVacioSub}</p>
      </div>
    );
  }
